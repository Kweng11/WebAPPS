           ...
           <div class="row">
            ...
            .catch(error => console.error('Error fetching data:', error));
                 ...
                 <script>
                  document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/mage') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
...
<div class="row">
               ...
               <script>
                document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/do') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
                ...
                document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/h') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
  ...
  <div class="row">
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        fetch('/s') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            // Fetch data from the PHP endpoint
            fetch('/lo') // Adjust the path to your PHP file
                .then(response => response.json())
                .then(data => {
...
<div class="row">
    ...
    document.addEventListener("DOMContentLoaded", () => {
        // Fetch data from the PHP endpoint
        fetch('/pl') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
                const months = data.map(item => item.dt);
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        // Fetch data from the PHP endpoint
        fetch('/ti') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
