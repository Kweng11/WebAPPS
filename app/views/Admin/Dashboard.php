           ...
           <div class="row">
            ...
            .catch(error => console.error('Error fetching data:', error));
                 ...
                 <script>
                  document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/damage') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
...
<div class="row">
               ...
               <script>
                document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/standing') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
                ...
                document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/crop') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
  ...
  <div class="row">
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        fetch('/seedling') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            // Fetch data from the PHP endpoint
            fetch('/location') // Adjust the path to your PHP file
                .then(response => response.json())
                .then(data => {
...
<div class="row">
    ...
    document.addEventListener("DOMContentLoaded", () => {
        // Fetch data from the PHP endpoint
        fetch('/transplate') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
                const months = data.map(item => item.dt);
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        // Fetch data from the PHP endpoint
        fetch('/total') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
