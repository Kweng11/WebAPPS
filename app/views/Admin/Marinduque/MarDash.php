           ...
           <div class="row">
             <div class="col-md-12 grid-margin">
               ...
               <div class="row">
                ...
                document.getElementById('Tabl').textContent = data.numFarmers || 0;
            })
            .catch(error => console.error('Error fetching data:', error));
                 ...
                 <script>
                  document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/mag') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
                        document.getElementById('Damag').textContent = data.total_damages || 0;
                      })
                      .catch(error => console.error('Error fetching data:', error));
                  });
                </script>
...
<div class="row">
               ...
               <script>
                document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/o') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
                ...
                document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/gh') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
  ...
  <div class="row">
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        fetch('/as') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            // Fetch data from the PHP endpoint
            fetch('/lol') // Adjust the path to your PHP file
                .then(response => response.json())
                .then(data => {
...
<div class="row">
    ...
    document.addEventListener("DOMContentLoaded", () => {
        // Fetch data from the PHP endpoint
        fetch('/plw') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
                const months = data.map(item => item.dt);
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        // Fetch data from the PHP endpoint
        fetch('/J') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
