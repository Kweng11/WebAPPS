                            ...
                            <tbody>
                              ...
                              <?php foreach ($infor as $d) : ?>
                                ...
                                <th scope="row"><?= $d['id'] ?></th>
                                  ...
                                  <td><?= $d['typhoon']; ?></td>
                                  <td><?= $d['heavy_rains']; ?></td>
                                  <td><?= $d['total_damages']; ?></td>
                                  <td><?= $d['standing_crop']; ?></td>
                                  <td><?= $d['transplate_date']; ?></td>
                                  <td><?= $d['expected_date']; ?></td>
                                  <td><?= $d['expected_area']; ?></td>
                                  <td><?= $d['expected_volume']; ?></td>
                                  <td><?= $d['cans_damages'];?></td>
                                  <td><a href="/delete-user/<?= $d['id']; ?>">DELETE USER</a> || <a href="/edit-user/<?= $d['id']; ?> ">EDIT USER </td>
                                </tr>
