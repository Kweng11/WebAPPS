           ...
           <div class="row">
            ...
            .catch(error => console.error('Error fetching data:', error));
                 ...
                 <script>
                  document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/dam') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
...
<div class="row">
               ...
               <script>
                document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/ding') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
                ...
                document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/cr') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
  ...
  <div class="row">
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        fetch('/seed') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            // Fetch data from the PHP endpoint
            fetch('/loc') // Adjust the path to your PHP file
                .then(response => response.json())
                .then(data => {
...
<div class="row">
    ...
    document.addEventListener("DOMContentLoaded", () => {
        // Fetch data from the PHP endpoint
        fetch('/plate') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
                const months = data.map(item => item.dt);
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        // Fetch data from the PHP endpoint
        fetch('/tal') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
