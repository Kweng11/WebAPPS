    ...
    public function damage()
{
    ...
    $query = "SELECT SUM(total_damages) as total FROM information ";
...
public function farmers()
{
    ...
    $query = "SELECT COUNT(*) AS numFarmers FROM information ";
...
public function standing()
{
    ...
    // Query to calculate total damages for a specific user
    $query = "SELECT SUM(standing_crop) as totalcrop FROM information";
...
public function crop()
{
    ...
    // Query to calculate total damages for a specific user
    $query = "SELECT SUM(cans_damages) as damages FROM information";
...
public function location()
{
    ...
    $query = $conn->prepare("SELECT location, COUNT(location) AS location_count FROM information GROUP BY location");
    $query->execute();
